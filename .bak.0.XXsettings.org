...
("e p"  org-latex-export-to-pdf "export latex")
...
("w"  z/narrow-or-widen-dwim "widen" )
...
#+END_SRC
** TODO auto check mail
http://www.emacswiki.org/emacs/gnus-autocheck.el
#+BEGIN_SRC emacs-lisp :results none
...
*** my details
#+BEGIN_SRC emacs-lisp :results none
(setq wl-from "Itai Kloog  <ikloog@gmail.com>"                  ;; my From:
)
#+END_SRC
*** base 1
#+BEGIN_SRC emacs-lisp :results none
...
;; Automatic signature insertion
      signature-file-name "/home/zeltak/.emacs.d/ikloog.sig"
