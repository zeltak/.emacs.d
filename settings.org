...
(defhydra hydra-unicode (:color blue)
  "unicode"
  (">"   (insert-char ?úÚ¢˚) "úÚ¢˚") ; C-x 8 RET 261b RET, pointing hand
  ("SPC" (insert-char ?úÙÚÎ)  "0-width space") ; C-x 8 RET 200b RET, zero width space
  ("\\"  (insert-char ?úÚ°Ó) "úÚ°Ó") ; C-x 8 RET 9646 RET, black vertical rectangle
  ("|"   (insert-char ?úÚ°Ô) "úÚ°Ô") ; C-x 8 RET 9647 RET, white vertical rectangle
  ("dd"  (insert-char ?ë°∞) "ë°∞") ; curved double quotes open
  ("df"  (insert-char ?ë°±) "ë°±") ; curved double quotes close
...
#+END_SRC
 ...
 (global-set-key (kbd "<f10> n ") (C-u M-x org-refileq))
