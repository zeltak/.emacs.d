...
(setq org-capture-templates
       ...
       `(
("J" "food" entry (file+headline "/home/zeltak/org/files/agenda/food.org" "Inbox")
	   ,org-capture-template-food ))))
...
***** Project Capture
      :PROPERTIES:
      :ID:       5cfd0783-0c54-4436-bdba-7898403b4c84
      :END:
  #+BEGIN_SRC emacs-lisp :results none  
    
(defvar org-capture-template-food
"* %^{TYPE|COOK|SHOP|LIBRARY} %?
:PROPERTIES:
:ID: %(org-id-uuid)
:Time: %^{minutes}
:Rating: %^{rating?|1|2|3|4|5}
:Source: %^{Source?}
:Amount: %^{ammount?|1|2|3|4|5|6|7|8}
:Amount: %^{Favorite?|y|n}
:END:
X** %^{prompt|Ingredients}

X** %^{prompt|Preperation}
"
...
now add to org templates 

  #+BEGIN_SRC emacs-lisp :results none 
  (setq org-capture-templates (append org-capture-templates
          `(("f" "Food")
            ("fr" "add recipe" entry (file org-project-project-file)
              ,org-capture-template-food )))) ))))
  #+END_SRC
