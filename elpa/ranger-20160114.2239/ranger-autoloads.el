...

;;;### (autoloads nil "ranger" "ranger.el" (22168 63246 666388 825000))
...
(when ranger-key (add-hook 'dired-mode-hook (defun ranger-set-dired-key nil (define-key dired-mode-map ranger-key 'deer))))
